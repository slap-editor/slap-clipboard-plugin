...
var BaseWidget = require.main.require('./node_modules/base-widget');
...
module.exports = function (slap) {
  ...
  Editor.prototype.paste = Promise.method(function () {
    ...
    return clipboard.pasteAsync()
      ...
      .then(function (text) {
        if (!text) text = self.data.clipboard;
  ...
  Editor.prototype.getBindings = function () {
    return _(Editor.prototype.__proto__.getBindings.call(this)).merge(opts.editor.bindings || {}).toObject();
  };
